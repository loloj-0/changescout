...
| llm_only | 50 | 0.660 | 0.786 | 9 | 0.286 |
...
* `data/annotation/evaluation/hybrid_lead_selection_qwen7b_direct/hybrid_lead_selection_metrics.csv`
* `data/annotation/evaluation/hybrid_lead_selection_qwen7b_direct/hybrid_leads.csv`
* `data/annotation/evaluation/hybrid_lead_selection_qwen7b_direct/hybrid_lead_selection_report.md`
