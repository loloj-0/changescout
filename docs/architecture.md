...
1. `results/evaluation/classical_text_classifier/classical_text_classifier_metrics.json`
2. `results/evaluation/classical_text_classifier/classical_text_classifier_predictions.csv`
3. `results/evaluation/classical_text_classifier/classical_text_classifier_report.md`
...
* `data/annotation/evaluation/triage_3class_dataset.csv`
* `results/evaluation/aligned_method_comparison/aligned_tfidf_predictions.csv`
* `results/evaluation/local_llm/<model>/<prompt_variant>/llm_triage_predictions.jsonl`
...
* `results/evaluation/hybrid_lead_selection_<llm_variant>/hybrid_lead_selection_metrics.csv`
* `results/evaluation/hybrid_lead_selection_<llm_variant>/hybrid_leads.csv`
* `results/evaluation/hybrid_lead_selection_<llm_variant>/hybrid_eval_records.csv`
* `results/evaluation/hybrid_lead_selection_<llm_variant>/hybrid_lead_selection_report.md`
...
* `results/evaluation/llm_explainability/llm_explainability_leads.csv`
* `results/evaluation/llm_explainability/llm_explainability_report.md`
* `results/evaluation/llm_explainability_generated/llm_explainability_generated.jsonl`
* `results/evaluation/llm_explainability_generated/llm_explainability_generated.csv`
* `results/evaluation/llm_explainability_generated/llm_explainability_generated_report.md`
...
* `data/annotation/evaluation/strict_binary_dataset.csv`
* `data/annotation/evaluation/actionable_binary_dataset.csv`
* `results/evaluation/aligned_method_comparison/aligned_method_comparison.csv`
* `results/evaluation/local_llm/comparison/local_llm_comparison.csv`
* `results/evaluation/hybrid_lead_selection_comparison/hybrid_lead_selection_comparison.csv`
* `results/evaluation/llm_explainability_generated/llm_explainability_generated_report.json`
